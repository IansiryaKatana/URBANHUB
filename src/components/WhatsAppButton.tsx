...
const WhatsAppButton = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-6 right-6 z-50 h-14 w-14 rounded-full bg-[#128C7E] text-white shadow-lg hover:bg-[#0E7368] transition-all duration-300 hover:scale-110 flex items-center justify-center"
