...
(
  ...
  'Stayed here for the 24/25 academic year. The studios are really well finished – proper en-suite, decent kitchenette, and the WiFi is solid for online lectures. Walking distance to University of Lancashire campus and the town centre. The rooftop terrace is a nice touch when the weather is good. Maintenance sorted any small issues within a day. Happy resident!',
  'approved',
  true,
  true,
